  ...
  describe('Results Controller Tests', function() {
    ...
    it(
      ...
      inject(function(Results) {
        ...
        // Set GET response
        $httpBackend.expectGET('nb_results').respond(200, '1', {
          'Content-Type': 'application/json'
        });
        $httpBackend.expectGET('results').respond(200, sampleResults, {
          'Content-Type': 'application/json'
        });
    ...
    it(
      ...
      inject(function(Results) {
        ...
        $httpBackend.expectGET(/results\/([0-9a-fA-F]{24})$/).respond(200, sampleResult, {
          'Content-Type': 'application/json'
        });
